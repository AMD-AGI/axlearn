...
from axlearn.common.utils import HybridMeshShape, MeshShape, get_data_dir, infer_mesh_shape
...
flags.DEFINE_integer(
    "step_to_cal_avg_step_time", None, "The number of steps to calculate and log average step time"
)
