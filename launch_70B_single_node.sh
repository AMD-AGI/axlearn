...
python3 -m axlearn.common.launch_trainer_main \
  ...
  --jax_backend=gpu --mesh_selector="gpu-remat-test" --trainer_dir="/work/single-node-70B/"  --trace_at_steps=0,3,6 
  #&>/work/fuji_70b_amd_log_level-3.log &